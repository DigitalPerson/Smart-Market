...
namespace SmartMarket
{
    ...
    partial void OnpublishedChanged();
		...
		internal EntitySet<Recommendation> Recommendations
		{
			get
			{
		...
		internal EntitySet<UserApp> UserApps
		{
			get
			{
    ...
    partial void OnadminChanged();
		...
		internal EntitySet<UserFeature> UserFeatures
		{
			get
			{
