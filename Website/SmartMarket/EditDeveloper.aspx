<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditDeveloper.aspx.cs" Inherits="EditDeveloper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body_ContentPlaceHolder" runat="Server">
    <div id="gallery">
        ...
        <table style="width: 50%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="phone_TextBox"
                        Display="Dynamic" ErrorMessage="Phone isn't valid." ValidationExpression="^\+\d{10,15}$"></asp:RegularExpressionValidator>
                </td>
            </tr>
        </table>
        <br />
        <asp:Button ID="submit_Button" runat="server" OnClick="submit_Button_Click" Text="Submit"
            ...
            <br />
            <br />
        <asp:LinkButton ID="findApps_LinkButton" runat="server" OnClick="findApps_LinkButton_Click">Find all apps?</asp:LinkButton>
        &nbsp;
    </div>
</asp:Content>
