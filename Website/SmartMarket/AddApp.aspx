<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddApp.aspx.cs" Inherits="AddApp" %>
    ...
    <div id="gallery">
        ...
        <table style="width: 50%;">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="appType_DropDownList" runat="server" CssClass="fields" AutoPostBack="True"
                        DataSourceID="appTypes_LinqDataSource" DataTextField="name" DataValueField="appTypeID">
                    </asp:DropDownList>
                    <asp:LinqDataSource ID="appTypes_LinqDataSource" runat="server" ContextTypeName="SmartMarketDataClassesDataContext"
                        EntityTypeName="" OrderBy="name" TableName="AppTypes">
                    </asp:LinqDataSource>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:LinqDataSource ID="categories_LinqDataSource" runat="server" ContextTypeName="SmartMarketDataClassesDataContext"
                        EntityTypeName="" OrderBy="name" TableName="Categories" Where="appTypeID == @appTypeID">
                        <WhereParameters>
                            <asp:ControlParameter ControlID="appType_DropDownList" DefaultValue="1" Name="appTypeID"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="description_TextBox" runat="server" TextMode="MultiLine" CssClass="fields"
                        Height="153px"></asp:TextBox>
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="description_TextBox"
                        Display="Dynamic" ErrorMessage="Description is required field"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:TextBox ID="whatIsNew_TextBox" runat="server" TextMode="MultiLine" CssClass="fields"
                        Height="153px"></asp:TextBox>
                </td>
            </tr>
        </table>
