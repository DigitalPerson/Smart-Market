<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditUser.aspx.cs" Inherits="EditUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body_ContentPlaceHolder" runat="Server">
    <div id="gallery">
        ...
        <table style="width: 50%;">
            ...
            <tr>
                <td class="style1">
                    <asp:Label ID="admin_Label" runat="server" Text="Admin" Visible="False"></asp:Label>
                </td>
                <td>
                    <asp:CheckBox ID="admin_CheckBox" runat="server" Visible="False" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <br />
        <br />
        <asp:HyperLink ID="registerAsDeveloper_HyperLink" runat="server" Visible="False">Register as developer?</asp:HyperLink>
        &nbsp;<asp:HyperLink ID="editDeveloperInfo_HyperLink" runat="server" Visible="False">Edit Develope Info?</asp:HyperLink>
    </div>
</asp:Content>
