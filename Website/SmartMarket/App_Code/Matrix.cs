...
namespace MatrixNamespace
{
    ...
    public class Matrix
    {
        ...
        #region Aiham & khalid
        public static void SetRow(Matrix X, Matrix Row, int i)
        {
            for (int j = 0; j < Row.NoCols; j++)
            {
                X[i, j] = Row[0, j];
            }
        }

        public static Matrix getRow(Matrix X, int i)
        {
            Matrix Row = new Matrix(1, X.NoCols);
        ...
        {
            Matrix Col = new Matrix(X.NoRows, 1);
        ...
        public static Matrix PowerTwo(Matrix X)
        {
            Matrix O = new Matrix(X.in_Mat);
        ...
        public static Matrix ValueMul(Matrix Mat1, Matrix Mat2)
        {
            Matrix output = new Matrix(Mat1.NoRows, Mat1.NoCols);

            for (int i = 0; i < Mat1.NoRows; i++)
            {
                for (int j = 0; j < Mat1.NoCols; j++)
                {
        ...
        public static Matrix Power(Matrix Mat)
        {
            Matrix output = new Matrix(Mat.NoRows, Mat.NoCols);

            for (int i = 0; i < Mat.NoRows; i++)
            {
                for (int j = 0; j < Mat.NoCols; j++)
                {
                    output[i, j] = Mat[i, j] * Mat[i, j];
                }

            }
            return output;
        }
        public static double Sum(Matrix Mat1)
        {
            double output = 0;
